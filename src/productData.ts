...
export const products: Product[] = [
  ...
  product({
    ...
    meta: 'Pedestal mount, ceiling fixed toilet partitions in 13mm DuraSafe compact laminate. Maximum rigidity and privacy for high-use washrooms.',
    intro: 'The DuraCube Pedestal Mount – Ceiling Fixed (PCF) system fixes the partition run to both the floor pedestal and the ceiling for maximum rigidity and secure privacy. Manufactured from 13mm DuraSafe compact laminate, it is a robust toilet cubicle solution for high-use washrooms where stability, sleek aesthetics and clean sightlines matter. Sturdy pedestal legs lift the panels clear of the floor, allowing quick cleaning with a mop or hose.',
  ...
  product({
    ...
    meta: 'Floor mount, ceiling fixed toilet cubicles in 13mm DuraSafe compact laminate. Sleek, rigid, space-efficient partitions for modern washrooms.',
    intro: 'The DuraCube Floor Mount – Ceiling Fixed (FCF) system anchors each partition to the floor and ceiling for a sleek, rigid, space-saving toilet cubicle. Manufactured from 13mm DuraSafe compact laminate, it delivers premium durability and a clean architectural finish for offices, retail and public amenities.',
  ...
  product({
    ...
    meta: 'Free-standing, floor-mounted toilet partitions in 13mm DuraSafe compact laminate. Flexible, waterproof cubicles for commercial and low-traffic restrooms.',
  ...
  product({
    ...
    meta: 'Full height Privacy Max (FHPM) toilet cubicles in 13mm DuraSafe compact laminate. Maximum privacy and a modern finish for non-residential washrooms.',
  ...
  product({
    ...
    meta: 'Design durable, compliant end-of-trip and change room facilities with DuraCube. Custom lockers, partitions, benches and vanities for workplaces and gyms.',
